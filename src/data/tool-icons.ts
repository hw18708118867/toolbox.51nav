...
const S: Record<string, string> = {
  ...
  'firewall': `<rect x="10" y="10" width="28" height="28" rx="2" fill="none" stroke="white" stroke-width="2.5"/><line x1="10" y1="19" x2="38" y2="19" stroke="white" stroke-width="2.5"/><line x1="10" y1="29" x2="38" y2="29" stroke="white" stroke-width="2.5"/><line x1="19" y1="10" x2="19" y2="38" stroke="white" stroke-width="2.5"/><line x1="29" y1="10" x2="29" y2="38" stroke="white" stroke-width="2.5"/><circle cx="24" cy="24" r="3" fill="white"/>`,
  'iptables': `<rect x="9" y="13" width="30" height="22" rx="2" fill="none" stroke="white" stroke-width="2.5"/><line x1="9" y1="20" x2="39" y2="20" stroke="white" stroke-width="2"/><line x1="9" y1="28" x2="39" y2="28" stroke="white" stroke-width="2"/><circle cx="16" cy="16.5" r="1.8" fill="white"/><circle cx="24" cy="16.5" r="1.8" fill="white"/><circle cx="32" cy="16.5" r="1.8" fill="white"/>`,
...
export const toolIcons: Record<string, IconDef> = {
  ...
  'google':            { bg: bg('security'), fg: `<circle cx="24" cy="24" r="12" fill="none" stroke="white" stroke-width="2.5"/><path d="M16 24h16M24 16a8 8 0 0 1 0 16" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round"/><path d="M28 20l3-4 3 2" fill="none" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>` },
  ...
  'firewalld':          { bg: bg('security'), fg: S['firewall'] },
  'iptables':           { bg: bg('security'), fg: S['iptables'] },
